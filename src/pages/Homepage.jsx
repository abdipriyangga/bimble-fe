...
const Homepage = () => {
  return (
    <div>
      ...
      <section className='bg-white w-full h-104 flex p-5'>
        <div className='w-1/2 p-3'>
          <div className='mt-10 ml-28'>
            <img src={ImageSecond} alt="image_left_section" width={380} height={380} />
          </div>
        </div>
        <div className='p-2 w-1/2'>
          ...
          <p className='text-justify text-sm mt-14 text-grey-400'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
        </div>
      </section>
      <section className='bg-white w-full h-104 flex p-5'>
        <div className='p-2 w-1/2'>
          <div className='text-black font-poppins font-bold mt-10'>
            ...
            <p className='text-4xl leading-relaxed'>Coba Try Out Online disini</p>
          </div>
          <p className='text-justify text-sm mt-14 text-grey-400'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
        </div>
        <div className='w-1/2 p-3'>
