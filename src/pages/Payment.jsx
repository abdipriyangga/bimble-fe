    ...
    <>
      <div className="p-6 flex justify-between">
        <div className="w-1/2 flex">
          ...
          <span className="text-main my-7 mx-2 text-xl font-bold">
            Back to School
          </span>
        </div>
        <div>
          <p className="text-black my-2 mx-2 text-4xl font-bold">Pembayaran</p>
          <p className="text-black my-2 mx-2 text-lg font-bold">
            No. 001100822452
          </p>
        </div>
      </div>
      ...
      <div className="p-10">
        <p className="text-center text-2xl font-bold text-grey-500 uppercase">
        ...
        <div className="text-center mt-10">
          <Link
            to="/auth/login"
            type="button"
            className="p-2 w-80 mx-2 text-black font-semibold bg-secMain border border-secMain rounded ease-linear transition-all duration-150 shadow hover:shadow-lg"
          >
            Upload Bukti Pembayaran
          </Link>
        </div>
      </div>
      <section className="p-10 ml-[21rem] mb-12 w-1/2 h-1/2">
        <div className="p-5 border ml-36 border-grey-400 w-80 h-80">
          ...
          <div className="w-full h-52 p-4 mt-6 border border-dashed">
            <div class="md:w-2/3 lg:w-full mt-14">
              <input
                class="bg-grey-200 appearance-none border-2 border-grey-200 rounded w-full py-2 px-4 text-grey-500 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                id="inline-full-name"
                type="file"
                placeholder="URL"
              />
